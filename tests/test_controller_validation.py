...
class ControllerValidationTests(unittest.TestCase):
    ...
    def test_controller_renders_when_config_is_valid(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertIn('class="page-status-panel" aria-label="Security Node status summary"', rendered)
            ...
            self.assertIn("max-width: 72rem;", rendered)
            self.assertIn(".page-main", rendered)
            self.assertIn(".page-header", rendered)
            self.assertIn(".page-brand", rendered)
            self.assertIn(".page-logo", rendered)
            self.assertIn(".page-heading-group", rendered)
            self.assertIn(".page-status-panel", rendered)
            self.assertIn(".page-status-panel .page-meta", rendered)
            self.assertIn(".page-status-panel .security-confidence", rendered)
            self.assertIn(".page-title", rendered)
            self.assertIn(".page-meta", rendered)
            self.assertIn("gap: 0.45rem;", rendered)
            self.assertIn("height: 3.2rem;", rendered)
            self.assertIn("width: 3.2rem;", rendered)
            ...
            self.assertIn("min-width: 42rem;", rendered)
            ...
            self.assertIn(".confidence-unknown {\n      background: #b3b6b6;\n      color: #53585f;", rendered)
            self.assertIn(".confidence-low {\n      background: #ff4539;\n      color: #ffffff;", rendered)
            ...
            self.assertIn('class="controller-state-item controller-state-controller-id-item"', rendered)
            self.assertIn('class="controller-state-item controller-state-display-name-item"', rendered)
            self.assertIn('class="controller-state-item controller-state-network-item"', rendered)
            self.assertIn('class="controller-state-item controller-state-capabilities-item"', rendered)
            self.assertIn('class="controller-state-item controller-state-scanner-evidence-max-age-item"', rendered)
            ...
            self.assertIn(".controller-state-item", rendered)
            self.assertIn(".controller-state-term", rendered)
            self.assertIn(".controller-state-value", rendered)
            self.assertIn("grid-template-columns: repeat(auto-fit, minmax(13rem, 1fr));", rendered)
            self.assertIn("gap: 0.35rem;", rendered)
            self.assertIn("color: rgba(83, 88, 95, 0.78);", rendered)
            self.assertIn("font-size: 0.85rem;", rendered)
            self.assertIn("min-height: 2.4rem;", rendered)
            self.assertIn("padding: 0.75rem;", rendered)
            ...
            self.assertIn("grid-template-columns: repeat(auto-fit, minmax(13rem, 1fr));", rendered)
            self.assertIn("list-style: none;", rendered)
            self.assertIn("background: rgba(179, 182, 182, 0.12);", rendered)
            self.assertIn("border-radius: 0.85rem;", rendered)
            self.assertIn("border-color: rgba(255, 69, 57, 0.32);", rendered)
            ...
            self.assertIn('class="table-scroll expected-surface-table-scroll"', rendered)
            ...
            self.assertIn("padding: 0.5rem 0.65rem;", rendered)
            self.assertIn("border-bottom: 1px solid rgba(83, 88, 95, 0.16);", rendered)
            self.assertIn("background: rgba(179, 182, 182, 0.18);", rendered)
            ...
            self.assertIn('class="table-scroll observed-results-table-scroll"', rendered)
            ...
            self.assertIn(".status-not-verified,\n    .status-unknown {\n      background: #b3b6b6;\n      color: #53585f;", rendered)
            self.assertIn(".status-verified {\n      background: #34c759;\n      color: #ffffff;", rendered)
            self.assertIn(".status-unexpected {\n      background: #ff4539;\n      color: #ffffff;", rendered)
