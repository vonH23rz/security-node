...
class ControllerValidationTests(unittest.TestCase):
    def test_controller_renders_when_config_is_valid(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertIn('class="posture-summary"', rendered)
            self.assertIn('class="summary-metric summary-metric-expected-surface"', rendered)
            self.assertIn('class="summary-metric summary-metric-expected-not-verified"', rendered)
            self.assertIn('class="summary-metric summary-metric-observed-results"', rendered)
            self.assertIn('class="summary-metric summary-metric-unexpected"', rendered)
